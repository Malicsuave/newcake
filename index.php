    ...
    <body>
        ...
        <main>
            ...
            <section class="slick-slideshow">   
                ...
                <div class="slick-custom">
                    <img src="photos/header 2.png" class="img-fluid" alt="">
                ...
                <div class="slick-custom">
                    <img src="photos/header 3.png" class="img-fluid" alt="">
                        ...
                        <div class="col-lg-10 col-12">
                            <div class="tab-content mt-2" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7 col-12">
                                            <img src="photos/4.jpg" class="img-fluid" alt="">
                                        </div>
                                ...
                                <div class="tab-pane fade" id="pills-skill" role="tabpanel" aria-labelledby="pills-skill-tab">
                                    <div class="row">
                                        <div class="col-lg-7 col-12">
                                            <img src="photos/5.jpg" class="img-fluid" alt="">
                                        </div>
                ...
                <div class="container-fluid p-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-12">
                            <img src="photos/6.jpg" class="img-fluid" alt="">
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-12 mb-3">
                            <div class="product-thumb">
                                <a href="product-detail.php">
                                    <img src="photos/8.jpg" class="img-fluid product-image" alt="">
                                </a>
                        ...
                        <div class="col-lg-4 col-12 mb-3">
                            <div class="product-thumb">
                                <a href="product-detail.php">
                                    <img src="photos/1.jpg" class="img-fluid product-image" alt="">
                                </a>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="product-thumb">
                                <a href="product-detail.php">
                                    <img src="photos/6.jpg" class="img-fluid product-image" alt="">
                                </a>
